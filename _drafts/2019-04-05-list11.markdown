...
A saucy paper about how to interpret so-called "rotational dynamics" observed from population recordings, for example in primary motor cortex. Also see this [tweet thread](https://twitter.com/JonAMichaels/status/1113438118143623168) in which it is pointed out that Lebedev et al. ought to have cited and discussed papers by Michaels et al. and by Sussillo et al.:
...
This paper is an interesting application of the method described in a paper from 2017:
