...
The debate is not new: are we to understand cognitive and neural functions by studying individual neurons, or is a network-level approach what we need? Saxena & Cunningham review areas of study in which analysis of neuronal populations has benefited our understanding of computation in the brain. Novel techniques and approaches for studying populations of neurons breathe new life into the idea that the network is the "essential unit of computation" in the brain.
