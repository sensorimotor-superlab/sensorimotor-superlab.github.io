...
**ChatGPT summary**: This study investigated the role of joint receptors in human position sense and found that they act as limit detectors when movements approach the anatomical limit of a joint. As the arm approaches full extension, a population of joint receptors becomes engaged and their signals are combined with those of muscle spindles to produce a composite that contains joint limit information, resulting in a fall in position errors.
