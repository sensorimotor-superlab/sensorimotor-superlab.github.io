...
Smeets J, Brenner E  
[Front. Integr. Neurosci.](http://dx.doi.org/10.3389/fnint.2023.1118240)
...
[Nat Rev Neurosci](http://dx.doi.org/10.1038/s41583-023-00691-z)
...
[bioRxiv](http://dx.doi.org/10.1101/2023.04.03.535429)
...
[bioRxiv](http://dx.doi.org/10.1101/2022.07.10.499496)
...
[bioRxiv](http://dx.doi.org/10.1101/2023.03.21.533618)
...
[Sci. Adv.](http://dx.doi.org/10.1126/sciadv.abo3505)
...
[Nat Commun](http://dx.doi.org/10.1038/s41467-023-36555-4)
...
[The Anatomical Record](http://dx.doi.org/10.1002/ar.25172)
...
[bioRxiv](http://dx.doi.org/10.1101/2022.06.29.498152)

**ChatGPT summary**: This study examines whether visual perceptual learning is specific to the motor system involved in the learning task or if it generalizes across different motor systems. Participants learned an orientation discrimination task using either joystick movements or manual reaches and were later tested using eye movements. The findings suggest that visual information is mapped onto effector-specific integrators during perceptual learning, but some generalization occurs due to overlap in the populations of neurons encoding motor plans across effectors.

<hr>## 10
**Neural timescales reflect behavioral demands in freely moving rhesus macaques**  
Manea A, Zilverstand A, Hayden B, Zimmermann J  
[bioRxiv](http://dx.doi.org/10.1101/2023.03.27.534470)
...
Burrows M, Sutton G  
[Science](http://dx.doi.org/10.1126/science.1240284)
...
[Nat Hum Behav](http://dx.doi.org/10.1038/s41562-023-01548-2)
